...
model.load_weights(r"../log/dbp/dbp_l2_weights_without_l1.hdf5", by_name=True)
#########################
model.compile('adam', 'categorical_crossentropy', metrics=['accuracy'])
model.summary()
print('Train...')
fileweights = r"../log/dbp/dbp_l3_weights_without_l2.hdf5"
...
loss,accuracy = model.evaluate([x_test], y3_test, verbose=0)
print('\ntest loss',loss,'accuracy',accuracy)
print('level3 without labels on the level 2: end up')

pred_l3 = model.predict([x_test], batch_size=batch_size)
